<html>
<head>
<title>IMAP webmail example</title>
</head>
<!--
======================================================================================================
...
-->
	...
	<frameset rows="100,*" frameborder="0" border="0" framespacing="0">
		<frame name="topNav" src="frames/top.phpW">
		<frameset cols="250,*" frameborder="0" border="0" framespacing="0">
			<frame name="menu" src="frames/mailboxes.php" marginheight="0" marginwidth="0" scrolling="auto" noresize>
			<frameset rows="300,*" frameborder="2" border="2" framespacing="0">
				<frame name="mailbox" src="frames/mailbox.php" marginheight="0" marginwidth="0" scrolling="auto" noresize>
				<frame name="msg" src="frames/msg.php" marginheight="0" marginwidth="0" scrolling="auto" noresize>
			</frameset>
		</frameset>
	</frameset>
</html>
